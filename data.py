...
cols = 8
customFontSize = 0
font = pygame.font.SysFont("impact", customFontSize)
moved = False
drawCPU = False
gameover = False
margin = 90
...
customcellHeight = 0
custompieces = {}
depth = 3 #C:/Users/mmodh/Desktop/Chess/Pictures/pieces
backHelp = pygame.image.load(os.path.join(dir + "/wood/backHelp.jpg"))
startWood = pygame.image.load(os.path.join(dir + "/wood/startWood.png"))
woodDark = pygame.image.load(os.path.join(dir + "/wood/woodDark.png"))
woodLight = pygame.image.load(os.path.join(dir + "/wood/woodLight.jpg"))
backWood = pygame.image.load(os.path.join(dir + "/wood/backWood.jpg"))
Wpawn = pygame.image.load(os.path.join(dir + "/pieces/WPawn.png"))
Bpawn =  pygame.image.load(os.path.join(dir + "/pieces/BPawn.png"))
Wbishop =  pygame.image.load(os.path.join(dir + "/pieces/WBishop.png"))
Bbishop =  pygame.image.load(os.path.join(dir + "/pieces/BBishop.png"))
Bknight =  pygame.image.load(os.path.join(dir + "/pieces/BKnight.png"))
Wknight =  pygame.image.load(os.path.join(dir + "/pieces/WKnight.png"))
Brook =  pygame.image.load(os.path.join(dir + "/pieces/BRook.png"))
Wrook =  pygame.image.load(os.path.join(dir + "/pieces/WRook.png"))
Bking =  pygame.image.load(os.path.join(dir + "/pieces/BKing.png"))
Wking =  pygame.image.load(os.path.join(dir + "/pieces/WKing.png"))
Bqueen =  pygame.image.load(os.path.join(dir + "/pieces/BQueen.png"))
Wqueen =  pygame.image.load(os.path.join(dir + "/pieces/WQueen.png"))
customWood = backHelp.copy()
customWoodCur = pygame.transform.scale(customWood, (5, 5))
customSize = 1
startField = False
