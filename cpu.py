...
#                     if gl.isValidMove(row, col, piece, oldRow, oldCol, turn, temp, data.playerTwo.p, other):
#                         temp[row][col] = piece
...
#         depth = 0
#         maxdepth = data.depth
#         pieces = data.playerTwo.p
#         otherPieces = data.playerOne.p
...
#     if piece in data.playerTwo.p:
#         if piece != None:
#             data.drawingpiece = piece
#         if otherPiece != None and otherPiece in data.playerOne.p:
#             data.playerOne.dead.append(otherPiece)
#             data.board[data.end[0]][data.end[1]] = None
#             data.playerOne.p.remove(otherPiece)
...
def drawCPUMove():
    ...
    if piece in data.playerOne.p:
        if piece != None:
            data.drawingpiece = piece
        if otherPiece != None and otherPiece in data.playerTwo.p:
            data.playerTwo.dead.append(otherPiece)
            data.board[data.end[0]][data.end[1]] = None
            data.playerTwo.p.remove(otherPiece)
        data.orgpiecex = piece.getCoor()[0]
        data.orgpiecey = piece.getCoor()[1]
        data.piecex = piece.getCoor()[0]
        data.piecey = piece.getCoor()[1]
